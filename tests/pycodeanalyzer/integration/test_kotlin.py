...
class TestKotlinIntegration:
    ...
    def test_kotlin_analysis(self, mocker):
        ...
        args.no_ui = True
        args.loglevel = "DEBUG"
        args.path = ["tests/ressources/code/kotlin_android_clean_architecture"]
        ...
        expected = open("./tests/ressources/kotlin_android_clean_architecture_dumpobj.json", "r").read().strip().replace("\r\n", "\n")
